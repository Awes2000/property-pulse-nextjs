        ...
        <div className="flex h-20 items-center justify-between w-full">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="md:hidden relative inline-flex items-center justify-center rounded-md p-2 mr-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
          ...
          <div className="flex items-center gap-4">
            {/* Login or Register Button (Logged Out) */}
            {!data && providers && Object.values(providers).map((provider) => (
              <button
                key={provider.id}
            ...
            {data && (
            <>
            <Link href="/messages" className="relative group hidden md:block" onClick={() => setIsProfileMenuOpen(false)}>
              <button
                type="button"
            ...
            {/* Profile dropdown button (Logged In) */}
              ...
              <div>
                ...
                >
                  ...
                  <Image
                    ...
                    src={data?.user?.image || profileDefault}
                    alt="User profile"
                    width={32}
                    height={32}
                  />
